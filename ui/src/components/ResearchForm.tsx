...
const ResearchForm: React.FC<ResearchFormProps> = ({
  ...
  return (
    <div className="relative" ref={formRef}>
      ...
      {/* Main Form */}
      <div className={`${glassStyle.card} backdrop-blur-2xl bg-black/60 border-gray-800 shadow-xl`}>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative group">
              <label
                htmlFor="companyName"
                className="block text-base font-medium text-gray-200 mb-2.5 transition-all duration-200 group-hover:text-white font-['DM_Sans']"
              >
                Company Name <span className="text-white/70">*</span>
              </label>
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/30 to-white/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-lg"></div>
                ...
                <input
                  ...
                  className={`${glassStyle.input} transition-all duration-300 focus:border-[#468BFF]/50 focus:ring-1 focus:ring-[#468BFF]/50 group-hover:border-[#468BFF]/30 bg-black/60 backdrop-blur-sm text-lg py-4 pl-12 font-['DM_Sans'] text-white placeholder-gray-400`}
          ...
          <button
            ...
            className="relative group w-fit mx-auto block overflow-hidden rounded-lg bg-black/60 backdrop-blur-sm border border-gray-700 text-white transition-all duration-500 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed px-12 font-['DM_Sans']"
          >
            ...
            <div className="relative flex items-center justify-center py-3.5">
              {isResearching ? (
                <>
                  ...
                  <span className="text-base font-medium text-white/90">Researching...</span>
                </>
              ) : (
                <>
                  <Search className="-ml-1 mr-2 h-5 w-5 text-white/90" />
                  <span className="text-base font-medium text-white/90">Start Research</span>
                </>
              )}
            </div>
          </button>
